...
pub struct AppEventHandler<D: BdkStorage, S: TenTenOneStorage, N: Storage + Sync + Send + 'static> {
    pub(crate) node: Arc<Node<D, S, N>>,
    pub(crate) event_sender: Option<EventSender>,
}

impl<D: BdkStorage, S: TenTenOneStorage, N: Storage + Sync + Send + 'static>
    AppEventHandler<D, S, N>
{
