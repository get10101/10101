...
use lightning::{
    chain::{chainmonitor, keysinterface::KeysManager, BestBlock, Filter},
...
async fn start_ln_dlc_node() {
    ...
    let persister = Arc::new(FilesystemPersister::new(ldk_data_dir));
    ...
    dbg!("Our Node ID: {}", channel_manager.get_our_node_id());
