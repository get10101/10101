...
#[derive(Clone)]
pub struct MakerTenTenOneStorage {
    pub ln_storage: Arc<FilesystemPersister>,
    pub dlc_storage: Arc<SledStorageProvider>,
    pub data_dir: String,
}

impl MakerTenTenOneStorage {
    pub fn new(data_dir: String) -> MakerTenTenOneStorage {
...
impl LDKStoreReader for MakerTenTenOneStorage {
    ...
    fn export(&self) -> anyhow::Result<Vec<(String, Vec<u8>)>> {
        unimplemented!("Exporting the makers lightning data is not supported")
    }
}

impl DlcStoreProvider for MakerTenTenOneStorage {
...
impl KVStorePersister for MakerTenTenOneStorage {
